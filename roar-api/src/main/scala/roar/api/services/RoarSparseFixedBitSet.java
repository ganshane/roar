 ...
 * @lucene.internal
 */
public class RoarSparseFixedBitSet extends BitSet implements Bits, Accountable {

    private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoarSparseFixedBitSet.class);
    ...
    public RoarSparseFixedBitSet(int length, long[] indices, long[][] bits, int nonZeroLongCount, long ramBytesUsed){
        this.length = length;
    ...
    public static RoarSparseFixedBitSet deserialize(ByteBuffer bb) throws IOException{
        /**
         final long[] indices;
         final long[][] bits;
         final int length;
        ...
        return new RoarSparseFixedBitSet(length,indices,bits,nonZeroLongCount,ramBytesUsed);
    }
    public static RoarSparseFixedBitSet deserialize(InputStream is) throws IOException{
        /**
         final long[] indices;
         final long[][] bits;
         final int length;
